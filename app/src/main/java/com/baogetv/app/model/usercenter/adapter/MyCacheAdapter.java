...
public class MyCacheAdapter extends RecyclerView.Adapter<MyCacheAdapter.ViewHolder> {
            ...
            bt_action.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (downloadInfo != null) {
                        ...
                        String filepath =
                                StorageManager.getCacheVideoPath()
                                        + File.separator + StorageManager.generateFileName() + ".apk";
                        downloadInfo = new DownloadInfo.Builder().setUrl(data.getUrl()).setPath(filepath).build();
                        downloadInfo.setDownloadListener(
                                new MyDownloadListener(new SoftReference(ViewHolder.this)) {
                                    @Override
                                    public void onRefresh() {
