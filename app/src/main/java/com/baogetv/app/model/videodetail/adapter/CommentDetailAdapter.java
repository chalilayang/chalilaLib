...
public class CommentDetailAdapter
        extends BaseItemAdapter<CommentData, CommentDetailAdapter.ViewHolder> implements CommentView.OnCommentListener {
    ...
    public class ViewHolder extends ItemViewHolder<CommentData> {
        ...
        public ViewHolder(View view) {
            ...
            replayCount = view.findViewById(R.id.replay_count);
        }
        ...
        public void bindData(CommentData data, int pos) {
            if (loadMoreTip != null) {
                ...
                if (mCommentView != null) {
                    if (replayCount != null) {
                        String format = mContext.getString(R.string.replay_count);
                        replayCount.setText(String.format(format, getDataCount()-1));
                        if (pos == 0) {
                            ((View)replayCount.getParent()).setVisibility(View.VISIBLE);
                        } else {
