...
public class CommentTextView extends ScaleTextView {
    /**
     * 所有评论数据
     */
    ...
    public CommentTextView setTalkColor (final int mTalkColor) {
    ...
    public CommentTextView setMaxlines (final int mMaxlines) {
    ...
    public CommentTextView setMoreStr (final String mMoreStr) {
    ...
    public CommentTextView setTalkStr (final String mTalkStr) {
    ...
    public CommentTextView setNameColor (final int mNameColor) {
    ...
    public CommentTextView setCommentColor (final int mCommentColor) {
        this.mCommentColor = mCommentColor;
        return this;
    }

    public CommentTextView (final Context context) {
        super (context);
    }
    ...
    public CommentTextView setonCommentListener (final onCommentListener mListener) {
