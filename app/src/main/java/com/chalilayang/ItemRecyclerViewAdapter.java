...
import com.chalilayang.ItemFragment.OnListFragmentInteractionListener;
...
public class ItemRecyclerViewAdapter extends RecyclerView.Adapter<ItemRecyclerViewAdapter
    ...
    public ItemRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener
            listener) {
        mValues = items;
        mListener = listener;
    }
