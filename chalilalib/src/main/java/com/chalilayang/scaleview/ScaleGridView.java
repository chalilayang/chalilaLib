...
/**
 * An GridView widget that can scale the child view of ListView according to the
 * screen.
...
public class ScaleGridView extends GridView {
    ...
    protected void onFinishInflate() {
        ...
        ScaleCalculator.getInstance(getContext().getApplicationContext()).scaleViewGroup(this);
    }
}
