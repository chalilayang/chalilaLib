...
public class ScaleToggleButton extends ToggleButton {
	...
	public ScaleToggleButton(Context context) {
		super(context);
	}
	
	public ScaleToggleButton(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	
	public ScaleToggleButton(Context context, AttributeSet attrs, int defStyle) {
